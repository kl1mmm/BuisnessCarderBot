...
#-Кнопки-----------------------------------------------------------------------------------------------------------------------
StartKey = types.KeyboardButton(text='Создать визитку.')
KeyHelp = types.KeyboardButton(text='Помощь и краткая аннотация к боту.')

KeyScreen = types.KeyboardButton('Меню')

KeyGo = types.KeyboardButton('Создание.')
KeyStop = types.KeyboardButton('Стоп. Я не готов.')
...
KeyThanks = types.KeyboardButton('Благодарю!')

KeyGetCard = types.KeyboardButton('Получить визитку.')
...
KeyContactsEmail = types.InlineKeyboardButton('Эл. почта ✉️', callback_data='email')
